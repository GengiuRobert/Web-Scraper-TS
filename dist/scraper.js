...
const extractAdditionalBooksInfo = async (newPageFromBrowser, bookLink) => {
...
const extractBooksInfo = () => {
    ...
    const convertRatingToDigit = (rating) => {
        switch (rating) {
            case "One":
                return 1;
                break;
    ...
    const convertPriceToNumber = (priveValue) => {
